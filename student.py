...
def manageStudent(): #Function For The Student Management System
  ...
  ------------------------------------------------------
 |======================================================| 
 |====  Welcome To Shivaji's Easy Recruit System  ======|
 |======================================================|
  ------------------------------------------------------

Enter 1 : To View Applicant's List 
Enter 2 : To Add New Applicant
Enter 3 : To Initiate Screening 
Enter 3 : To Search Applicant 
Enter 4 : To Remove Applicant 
